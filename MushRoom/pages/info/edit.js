...
Page({
  data:{
    ...
    time:'请选择时间',
    types: [{ name: '1', value: '找单间', checked: true }, { name: '2', value: '找整房' }, { name: '3', value: '招室友' }],
  ...
  formSubmit:function(e){
    ...
    if(that.data.data.departure == '住址'){
    ...
    if(data.time == '请选择入住时间'){
      util.isError('请选择入住时间', that);
      return false;
    }
    if(data.surplus == '0'){
      var arr = new Array('','房间','厕所');
